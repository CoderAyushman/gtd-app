...
const Inbox = () => {
  ...
  const [priority, setPriority] = useState<'inbox' | 'next_action' | 'project'>('inbox');
  ...
  useEffect(() => {
    ...
    console.log("filteredTaskByType", filteredTaskByType)
    if (searchQuery === '') {
      const filtered =
  ...
  }, [filter, tasks, searchQuery, priority])
    ...
    <View style={styles.container} >
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.filters}>
          <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#000' }}>Inbox</Text>
          {contexts.length > 0 && (
